...
from dataset.search_dataset import search_train_dataset_decouple as search_train_dataset
...
def create_dataset(config, evaluate=False):
    ...
    test_dataset1 = search_test_dataset(config["test_file1"], config, test_transform)
    test_dataset2 = search_test_dataset(config["test_file2"], config, test_transform)
    if evaluate:
        return None, test_dataset1, test_dataset2
